    ...
    return (
      <div className="min-h-screen bg-[#020202] flex items-center justify-center relative overflow-hidden">
        ...
        <div className="relative z-10 bg-[#1a1a1a] border border-[#2a2a2a] rounded-2xl p-8 w-full max-w-md shadow-2xl flex flex-col items-center gap-6">
          ...
          {imageBase64 ? (
            <div className="w-28 h-36 border border-red-900/30 bg-black/60 rounded-xl p-1.5 flex items-center justify-center shadow-lg shadow-red-950/20 overflow-hidden">
              <img
            ...
            <div className="w-28 h-36 border border-[#2a2a2a] bg-black/20 rounded-xl flex items-center justify-center">
              <span className="text-[10px] text-white/20 uppercase tracking-widest text-center px-4">
                Esperando captura...
              </span>
            </div>
          )}
