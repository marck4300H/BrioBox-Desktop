        ...
        <div className="flex-1 p-8 flex flex-col gap-8">
          <div className="grid grid-cols-3 gap-4">
            {stats.map((stat, i) => (
              <div
                key={i}
                className={`rounded-xl p-5 border flex flex-col gap-3 transition-all duration-500 hover:scale-[1.02] ${dark
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  <span className={`text-[10px] px-2 py-0.5 rounded-full tracking-wide ${stat.positive
